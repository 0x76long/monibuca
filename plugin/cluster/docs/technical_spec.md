...
|----------|--------|-------------|
| `/api/cluster/nodes` | GET | List all nodes in the cluster |
| `/api/cluster/nodes/:id` | GET | Get detailed information about a node |
| `/api/cluster/nodes/:id` | PUT | Update node configuration |
| `/api/cluster/nodes/:id` | DELETE | Remove a node from the cluster |
| `/api/cluster/streams` | GET | List all streams in the cluster |
| `/api/cluster/streams/:path` | GET | Get detailed information about a stream |
| `/api/cluster/balance` | POST | Trigger manual load balancing |
| `/api/cluster/stats` | GET | Get cluster-wide statistics |
| `/api/cluster/topology` | GET | Get cluster topology information |
